...
@section('content')
        ...
        <div class="max-w-4xl mx-auto w-full z-10 relative flex-grow flex flex-col justify-center">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden p-6 md:p-10 lg:p-12 border-t-4 border-amber-500 w-full" data-aos="fade-up">
                ...
                <p class="text-md md:text-lg text-gray-700 leading-relaxed text-center mb-8 max-w-2xl mx-auto">
                    Orek tempe kering dan basah dengan paduan rasa manis, gurih, dan sedikit pedas. Lauk praktis yang cocok dipadukan dengan nasi hangat.
                ...
                <div class="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-lg mb-8 group" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('Assets/orekTempe.jpg') }}" alt="Rendang Daging Sapi" class="w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span class="text-white text-xl md:text-2xl font-bold">Orek Tempe</span>
                    </div>
                </div>
                ...
                <div class="bg-amber-50 rounded-2xl p-6 md:p-8 mb-8 shadow-md" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <ul class="list-none text-gray-700 leading-relaxed space-y-3">
                        <li class="flex items-start">
                            ...
                            <span>1 papan tempe ukuran sedang, potong korek api tipis</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>Minyak goreng secukupnya untuk menggoreng tempe</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1 batang serai, memarkan</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1 sdm air asam jawa (larutkan dengan sedikit air)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>2 sdm kecap manis</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>Garam dan gula pasir secukupnya</span>
                        </li>
                        <li><span class="font-semibold text-gray-900">Bumbu Iris:</span></li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>5 siung bawang merah, iris tipis</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>3 siung bawang putih, iris tipis</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>3 buah cabai merah keriting, iris serong (sesuai selera)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>2 buah cabai rawit merah, iris serong (opsional)</span>
                        </li>
                    </ul>
                </div>
 ...
 <div class="bg-amber-50 rounded-2xl p-6 md:p-8 shadow-md" data-aos="fade-up" data-aos-delay="700">
                    ...
                    <ol class="list-decimal list-inside text-gray-700 leading-relaxed space-y-4 text-base md:text-lg">
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">1. Goreng Tempe:</span> Panaskan minyak goreng dalam jumlah cukup banyak. Goreng tempe hingga kering dan renyah. Angkat dan tiriskan. Sisihkan minyak bekas menggoreng tempe, sisakan sedikit untuk menumis bumbu.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">2. Tumis Bumbu Iris:</span> Dengan sedikit minyak sisa goreng tempe, tumis bawang merah, bawang putih, cabai merah keriting, dan cabai rawit hingga harum dan layu. Masukkan daun salam, serai, dan lengkuas. Aduk hingga harum.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">3. Masukkan Bumbu Lain:</span> Masukkan air asam jawa, kecap manis, garam, dan gula pasir. Aduk rata hingga gula larut dan bumbu mengental serta sedikit berkaramel. Koreksi rasa.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">4. Campur Tempe:</span> Masukkan tempe goreng ke dalam bumbu. Aduk cepat hingga tempe terlumuri rata dengan bumbu. Pastikan api sudah kecil atau dimatikan agar tempe tetap renyah (untuk orek kering) atau biarkan sedikit basah (untuk orek basah).
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">5. Sajikan:</span> Angkat orek tempe dan sajikan hangat dengan nasi putih. Orek tempe juga enak disantap sebagai lauk pendamping atau bekal.
                        </li>
                    </ol>
                </div>                {{-- Bagian Baru: Video Tutorial (dengan Thumbnail yang bisa diklik) --}}
                <div class="bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md mt-8" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="relative aspect-w-16 aspect-h-9 w-full rounded-lg overflow-hidden shadow-lg group">
                        ...
                        @php
                            ...
                            $youtubeThumbnailUrl = "https://img.youtube.com/vi/6xc9PwlpAXw/hqdefault.jpg"; // Kualitas tinggi default
                            $youtubeVideoUrl = "https://www.youtube.com/watch?v=6xc9PwlpAXw";
                        @endphp

                        <a href="https://www.youtube.com/watch?v=6xc9PwlpAXw" target="_blank" rel="noopener noreferrer" class="block w-full h-full relative">
                            <img src="https://img.youtube.com/vi/6xc9PwlpAXw/hqdefault.jpg" alt="Video Tutorial Rendang" class="w-full h-full object-cover object-center transition-transform duration-300 group-hover:scale-105">
                    ...
                    <p class="text-gray-600 text-sm mt-4 text-center">
                        Klik gambar di atas untuk menonton video tutorial langkah demi langkah membuat Orek Tempe yang sempurna di YouTube!
                    </p>
                </div>
