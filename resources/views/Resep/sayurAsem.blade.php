        ...
        <div class="max-w-4xl mx-auto w-full z-10 relative flex-grow flex flex-col justify-center">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden p-6 md:p-10 lg:p-12 border-t-4 border-amber-500 w-full" data-aos="fade-up">
                ...
                <p class="text-md md:text-lg text-gray-700 leading-relaxed text-center mb-8 max-w-2xl mx-auto">
                     Sayur asem adalah sup sayuran khas Indonesia dengan cita rasa asam, manis, dan sedikit pedas yang menyegarkan.
                </p>
                ...
                <div class="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-lg mb-8 group" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('Assets/sayurAsem.jpg') }}" alt="Rendang Daging Sapi" class="w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span class="text-white text-xl md:text-2xl font-bold">Sayur Asem</span>
                    </div>
                </div>
                 ...
                 <div class="bg-amber-50 rounded-2xl p-6 md:p-8 mb-8 shadow-md" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <ul class="list-none text-gray-700 leading-relaxed space-y-3">
                        <li class="flex items-start">
                            ...
                            <span>1 liter air</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>50 gr melinjo</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>50 gr labu siam, potong dadu</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1 buah jagung manis, potong-potong</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>50 gr kacang panjang, potong-potong</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1 genggam daun melinjo muda</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>2 sdm asam jawa, larutkan dengan sedikit air</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>Garam dan gula pasir secukupnya</span>
                        </li>
                        <li><span class="font-semibold text-gray-900">Bumbu Halus:</span></li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>6 siung bawang merah</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>3 buah cabai merah besar (sesuai selera)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1 ruas terasi, bakar</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>1/2 ruas kunyit (opsional, untuk warna)</span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="bg-amber-50 rounded-2xl p-6 md:p-8 shadow-md" data-aos="fade-up" data-aos-delay="700">
                    ...
                    <ol class="list-decimal list-inside text-gray-700 leading-relaxed space-y-4 text-base md:text-lg">
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">1. Siapkan Sayuran:</span> Cuci bersih semua sayuran. Potong melinjo dan labu siam sesuai selera. Potong jagung menjadi beberapa bagian. Potong kacang panjang sekitar 2-3 cm. Sisihkan.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">2. Haluskan Bumbu:</span> Haluskan bawang merah, bawang putih, cabai merah besar, dan terasi. Jika menggunakan kunyit, haluskan juga bersama bumbu lainnya.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">3. Masak Kuah:</span> Didihkan air dalam panci. Masukkan bumbu halus, daun salam, dan lengkuas. Aduk rata.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">4. Masukkan Sayuran Keras:</span> Masukkan melinjo dan jagung manis. Masak hingga melinjo dan jagung setengah matang.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">5. Masukkan Sayuran Lain:</span> Tambahkan labu siam dan kacang panjang. Masak hingga semua sayuran empuk.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">6. Bumbui:</span> Masukkan larutan air asam jawa, garam, dan gula pasir. Aduk rata dan koreksi rasa. Masak sebentar hingga bumbu meresap.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">7. Masukkan Daun Melinjo:</span> Terakhir, masukkan daun melinjo muda. Masak sebentar saja hingga daun melinjo layu dan warna tetap hijau segar. Matikan api.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">8. Sajikan:</span> Sayur asem siap disajikan hangat dengan nasi putih dan lauk pendamping seperti ikan asin atau tempe goreng.
                        </li>
                    </ol>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md mt-8" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="relative aspect-w-16 aspect-h-9 w-full rounded-lg overflow-hidden shadow-lg group">
                        ...
                        @php
                            ...
                            $youtubeThumbnailUrl = "https://img.youtube.com/vi/X0qb3KzNYJQ/hqdefault.jpg"; // Kualitas tinggi default
                            $youtubeVideoUrl = "https://www.youtube.com/watch?v=X0qb3KzNYJQ";
                        @endphp

                        <a href="https://www.youtube.com/watch?v=X0qb3KzNYJQ" target="_blank" rel="noopener noreferrer" class="block w-full h-full relative">
                            <img src="https://img.youtube.com/vi/X0qb3KzNYJQ/hqdefault.jpg" alt="Video Tutorial Rendang" class="w-full h-full object-cover object-center transition-transform duration-300 group-hover:scale-105">
                    ...
                    <p class="text-gray-600 text-sm mt-4 text-center">
                        Klik gambar di atas untuk menonton video tutorial langkah demi langkah membuat Sayur Asem yang sempurna di YouTube!
                    </p>
                </div>
