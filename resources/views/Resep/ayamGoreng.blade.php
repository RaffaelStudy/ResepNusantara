        ...
        <div class="max-w-4xl mx-auto w-full z-10 relative flex-grow flex flex-col justify-center">
            <div class="bg-white rounded-3xl shadow-xl overflow-hidden p-6 md:p-10 lg:p-12 border-t-4 border-amber-500 w-full" data-aos="fade-up">
                ...
                <p class="text-md md:text-lg text-gray-700 leading-relaxed text-center mb-8 max-w-2xl mx-auto">
                    Ayam goreng klasik dengan bumbu kuning yang meresap sempurna, menghasilkan daging yang gurih, empuk di dalam, dan renyah di luar.
                </p>
                ...
                <div class="relative w-full h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden shadow-lg mb-8 group" data-aos="zoom-in" data-aos-delay="200">
                    <img src="{{ asset('Assets/ayamGoreng.jpg') }}" alt="Rendang Daging Sapi" class="w-full h-full object-cover object-center transition-transform duration-500 group-hover:scale-105">
                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-6">
                        <span class="text-white text-xl md:text-2xl font-bold">Ayam Goreng</span>
                    </div>
                </div>
               ...
               <div class="bg-amber-50 rounded-2xl p-6 md:p-8 mb-8 shadow-md" data-aos="fade-up" data-aos-delay="600">
                    ...
                    <ul class="list-none text-gray-700 leading-relaxed space-y-3">
                        <li class="flex items-start">
                            ...
                            <span>1 ekor ayam, potong 8 bagian, cuci bersih</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>500 ml air kelapa (opsional, bisa diganti air biasa)</span>
                        </li>
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                        ...
                        <li class="flex items-start">
                            <svg class="w-6 h-6 text-amber-600 mr-3 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M10 12l2 2 4-4"></path></svg>
                            <span>Minyak goreng untuk menggoreng</span>
                        </li>
                ...
                {{-- Konten Cara Memasak --}}
                 <div class="bg-amber-50 rounded-2xl p-6 md:p-8 shadow-md" data-aos="fade-up" data-aos-delay="700">
                    ...
                    <ol class="list-decimal list-inside text-gray-700 leading-relaxed space-y-4 text-base md:text-lg">
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">1. Ungkep Ayam:</span> Haluskan semua bahan bumbu halus. Dalam wajan, masukkan ayam, bumbu halus, daun salam, serai, dan air kelapa (atau air biasa). Tambahkan garam. Masak dengan api sedang hingga mendidih.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">2. Masak Hingga Empuk:</span> Kecilkan api, masak terus hingga ayam empuk dan bumbu meresap sempurna serta kuah mengering atau asat. Angkat ayam dan tiriskan.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">3. Goreng Ayam:</span> Panaskan minyak goreng dalam jumlah banyak. Goreng ayam yang sudah diungkep hingga berwarna kuning keemasan dan kulitnya renyah. Jangan terlalu lama agar daging tidak kering.
                        </li>
                        <li class="pl-2">
                            <span class="font-semibold text-gray-900">4. Sajikan:</span> Angkat ayam goreng, tiriskan minyak berlebih, dan sajikan selagi hangat. Cocok disajikan dengan nasi putih, sambal, dan lalapan.
                        </li>
                    </ol>
                </div>
                ...
                <div class="bg-gray-50 rounded-2xl p-6 md:p-8 shadow-md mt-8" data-aos="fade-up" data-aos-delay="800">
                    ...
                    <div class="relative aspect-w-16 aspect-h-9 w-full rounded-lg overflow-hidden shadow-lg group">
                        ...
                        @php
                            ...
                            $youtubeThumbnailUrl = "https://img.youtube.com/vi/j3DiLQOJLUc/hqdefault.jpg"; // Kualitas tinggi default
                            $youtubeVideoUrl = "https://www.youtube.com/watch?v=j3DiLQOJLUc";
                        @endphp

                        <a href="https://www.youtube.com/watch?v=j3DiLQOJLUc" target="_blank" rel="noopener noreferrer" class="block w-full h-full relative">
                            <img src="https://img.youtube.com/vi/j3DiLQOJLUc/hqdefault.jpg" alt="Video Tutorial Rendang" class="w-full h-full object-cover object-center transition-transform duration-300 group-hover:scale-105">
                    ...
                    <p class="text-gray-600 text-sm mt-4 text-center">
                        Klik gambar di atas untuk menonton video tutorial langkah demi langkah membuat Ayam Goreng yang sempurna di YouTube!
                    </p>
                </div>
